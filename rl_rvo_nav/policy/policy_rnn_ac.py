...
class rnn_ac(nn.Module):
    ...
    activation=nn.ReLU, output_activation=nn.Tanh, output_activation_v= nn.Identity,
                 use_gpu=False, rnn_mode='GRU', drop_p=0):
        super().__init__()
...
class GaussianActor(Actor):
    ...
    def _distribution(self, obs, std_factor=1): #用来生成动作分布
